...
function NewWindowInterface()
	...
	if not NewWindow.CheckOpen() then return end
		...
		RenderImage(31312, PosXWindow, 0, 190, 428)
		RenderImage(31340, PosXWindow, 0, 190, 64)
		RenderImage(31342, PosXWindow, 64, 21, 320)
		RenderImage(31343, PosXWindow + 169, 64, 21, 320)
		RenderImage(31344, PosXWindow, 384, 190, 45)
		...
		SetTextBg(0,0,0,0)
		RenderText5(PosXWindow, 12, string.format(CONFIG.MESSAGES[1]), 190, 3)
		...
		if NewWindow.ButtonMouseOver(CONFIG.ButtonID.fechar, MousePosX(), MousePosY()) then
			DrawTooltip((PosXWindow + 190 - 40), 20,string.format(CONFIG.MESSAGES[2]))
		...
		if NewWindow.ButtonMouseOver(CONFIG.ButtonID.ok, MousePosX(), MousePosY()) then
			RenderImage2(31319, PosXWindow + 48, 165, 110, 25,0, 0.2264566, 1.0, 0.2245212, 1, 1, 1.0)
			...
			RenderImage2(31319, PosXWindow + 48, 165, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
		end

		SetFontType(1)
		SetTextColor(255, 255, 255, 255)
		RenderText5(PosXWindow, 172, string.format(CONFIG.MESSAGES[1]), 190, 3)
